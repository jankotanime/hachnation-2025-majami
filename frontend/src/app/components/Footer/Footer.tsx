...
const Footer = () => {
    return (
        <footer className="w-full" style={{ backgroundColor: 'var(--surface)', color: 'var(--onSurface)' }}>
            <div className="pt-8">
                <div className="h-1 w-full" style={{ backgroundColor: 'var(--accent-red-400)'}}></div>
            </div>
            <div className="px-8 py-12 max-w-6xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                    <div>
                        <h3 className="text-lg font-bold mb-4" style={{ color: 'var(--accent-red-400)' }}>O projekcie</h3>
                    ...
                    <div>
                        <h3 className="text-lg font-bold mb-4" style={{ color: 'var(--accent-red-400)' }}>Nawigacja</h3>
                    ...
                    <div>
                        <h3 className="text-lg font-bold mb-4" style={{ color: 'var(--accent-red-400)' }}>Informacje</h3>
                        <p className="text-sm leading-relaxed opacity-90">
                ...
                <div className="border-t" style={{ borderColor: 'var(--accent-red-400)' }} >
